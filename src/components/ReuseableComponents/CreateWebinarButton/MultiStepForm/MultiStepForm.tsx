...
import { createWebinar } from '@/actions/wabinar'
...
const handleNext = async()=>{
  ...
  if(!isValid){
    setValidationError('plz fill in all required fields')
    return
  }
    ...
    {isCompleted? (
      ...
      {index < steps.length - 1 && (
        ...
        >
                  ...
                  <div className='pt-1'>
                    <motion.h3
                    animate={{color: isCurrent || isCompleted ? 'rgb(255, 255, 255)' : 'rgb(156, 163, 175)'}}
                    transition={{duration: 0.3}}
          ...
          >
            ...
            {/* Rnder the current step component */}
            {currentStep.component}


            {/* Validation error message */}
            {validationError && (
              <div className='mt-4 p-3 bg-red-900/30 border border-red-800 rounded-md flex items-center gap-2 text-red-300'>
